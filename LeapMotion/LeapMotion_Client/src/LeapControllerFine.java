			...
			switch (gesture.type()) 
			{
				...
				case TYPE_CIRCLE:
					...
					if(circle.state() != State.STATE_START)
					{
						...
						//dataOutput += sweptAngle;
						//System.out.println(dataOutput);
						//angle += Math.toDegrees(sweptAngle);
						//System.out.println(angle);
						progressInt = (int) circle.progress();
						if (progressInt > progressIntOld)
						{
							progressIntOld = progressInt;
							//System.out.println(progressIntOld);
						}
					}
					...
					//Window.getStatus(circle.progress());
					break;
			default:
				break;
...
public class LeapControllerFine {
